<template>
  <el-dialog v-if="selected" v-model="modifyPopupByBusinessNumber" title="매체사 수정" width="900" >
    <div class="comm_comp">
      <div class="comm_comp_table">
            ...
            <el-row :gutter="10">
              <el-col :span="20">
                <el-input
                  ...
                  class="" placeholder="사업자 명을 입력 해주세요." />
              </el-col>
            </el-row>
        ...
        <el-row :gutter="10">
          <el-col :span="6" class="col_tit">
            <strong class="comm_tit_box">사업자 번호
            </strong>
          </el-col>
          <el-col :span="16" class="col_desc">
            <el-row :gutter="10">
...
function modify() {
  validate('alReadyCheck', 'businessName', 'businessNumber', 'businessRegistrationFile')
