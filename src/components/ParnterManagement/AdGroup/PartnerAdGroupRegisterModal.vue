<template>
  <el-dialog v-model="adGroups.registerModal" title="광고 그룹 등록" width="700">
        ...
        <el-row :gutter="10">
          ...
          <el-col :span="16" class="col_desc">
            <el-row :gutter="10">
              <el-col :span="16">
                <el-input
                  v-model="adGroups.register.pointName"
        ...
        <el-row :gutter="10">
          ...
          <el-col :span="16" class="col_desc">
            <el-row :gutter="10">
              <el-col :span="16">
                <el-input
                  v-model="adGroups.register.callBackUrl"
...
defineOptions({
  name: 'PartnerAdGroupRegisterModal'
})
